//! Cryptographic primitives for NexChain: Ed25519 keys and signatures.
//!
//! This is the first slice of the `nex-crypto` crate from
...
mod tests {
    ...
    fn sign_verify_roundtrip() {
        ...
        let sig = kp.sign(b"hello nexchain");
        assert!(kp.public().verify(b"hello nexchain", &sig));
    }
